...
def build_pipeline(
    ...
    direct_user_processor=None,
    direct_response_guard=None,
):
    ...
    post_llm = []
    if direct_response_guard:
        post_llm.append(direct_response_guard)
    post_llm.append(pipeline_engine_callback_processor)
    if recording_router:
        post_llm.append(recording_router)

    processors.append(direct_user_processor or user_context_aggregator)
