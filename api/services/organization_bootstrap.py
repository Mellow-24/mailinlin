...
async def ensure_organization_bootstrapped(
    ...
    *,
    ...
    configuration_snapshot = (
        await get_organization_ai_model_configuration_v2_snapshot(organization_id)
    )
...
async def _bootstrap_organization(
    ...
    *,
    ...
    configuration_snapshot: OrganizationAIModelConfigurationV2Snapshot,
    ...
    if configuration is None:
        ...
        await upsert_organization_ai_model_configuration_v2(
            organization_id,
            configuration,
            expected_snapshot=configuration_snapshot,
        )
