...
from api.services.configuration.options import DASHSCOPE_DEFAULT_EMBEDDING_MODEL

from .azure_openai_service import AzureOpenAIEmbeddingService
from .base import BaseEmbeddingService
from .dashscope_service import DashScopeEmbeddingService
...
async def build_embedding_service(
    *,
    ...
    if provider == ServiceProviders.DASHSCOPE.value:
        return DashScopeEmbeddingService(
            db_client=db_client,
            api_key=api_key,
            model_id=model or DASHSCOPE_DEFAULT_EMBEDDING_MODEL,
            base_url=base_url,
        )
