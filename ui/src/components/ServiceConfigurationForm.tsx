...
const VOICE_DISPLAY_NAMES: Record<string, string> = {
    "longjiaxin_v3": "龙嘉欣 — 优雅粤语女声",
    "longjiayi_v3": "龙嘉怡 — 知性粤语女声",
    "longanyue_v3": "龙安粤 — 粤语男声",
    "zh-HK-HiuMaanNeural": "HiuMaan — Cantonese female",
    "zh-HK-HiuGaaiNeural": "HiuGaai — Cantonese female",
...
function getFieldDisplayName(field: string, value: string): string {
    if (field === "language") {
